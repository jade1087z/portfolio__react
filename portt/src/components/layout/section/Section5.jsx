                ...
                <div className="sec5__text">
                    <div className="HIDDEN img">
                        <div className="reveal5 BTT10">
                            <img
                                src="https:////source.unsplash.com/500x500/?water"
                                alt=""
                            />
                        </div>
                    </div>
                    ...
                    <div className="HIDDEN ml10">
                        <div className="reveal5 BTT12">& SKILL</div>
                    </div>
                </div>
            </div>
                ...
                <div className="right">
                    <div className="right__wrap r1">
                        ...
                        <div className="profile__text ">
                            <p className="profile__subTit whiteSpaceNo split4-2">
                                What do you think makes front-end development
                                attractive?
                            </p>
                            <p className="profile__subDe split4-3">
                                프론트엔드의 영역은 코드와 디자인이 만나는
                                독특한 공간이기에, 웹 개발에 있어 프론트엔드가
                                할 수 있는 일이 정말 많다고 생각합니다. 그만큼
                                부딪혀야 할 일이 많아 험난할 것이라 예상되지만
                                개발의 전반적인 부분을 담당할 수 있다는 점
                                때문에, 한 켠으로는 설레는 일이라 생각됩니다.
                            </p>
                        </div>
                    </div>
                    <div className="right__wrap r2">
                        ...
                        <div className="profile__text ">
                            <p className="profile__subTit whiteSpaceNo split4-5">
                                What do you think makes front-end development
                                attractive?
                            </p>
                            <p className="profile__subDe split4-6">
                                프론트엔드의 영역은 코드와 디자인이 만나는
                                독특한 공간이기에, 웹 개발에 있어 프론트엔드가
                                할 수 있는 일이 정말 많다고 생각합니다. 그만큼
                                부딪혀야 할 일이 많아 험난할 것이라 예상되지만
                    ...
                    <div className="right__wrap r3">
                        ...
                        <div className="profile__text ">
                            <p className="profile__subTit whiteSpaceNo split4-8">
                                What do you think makes front-end development
                                attractive?
                            </p>
                            <p className="profile__subDe split4-9">
                                프론트엔드의 영역은 코드와 디자인이 만나는
                                독특한 공간이기에, 웹 개발에 있어 프론트엔드가
                                할 수 있는 일이 정말 많다고 생각합니다. 그만큼
                                부딪혀야 할 일이 많아 험난할 것이라 예상되지만
                    ...
                    <div className="right__wrap r4">
                        ...
                        <div className="profile__text ">
                            <p className="profile__subTit whiteSpaceNo split4-11">
                                What do you think makes front-end development
                                attractive?
                            </p>
                            <p className="profile__subDe split4-12">
                                프론트엔드의 영역은 코드와 디자인이 만나는
                                독특한 공간이기에, 웹 개발에 있어 프론트엔드가
                                할 수 있는 일이 정말 많다고 생각합니다. 그만큼
                                부딪혀야 할 일이 많아 험난할 것이라 예상되지만
                    ...
                    <div className="right__wrap r5">
                        ...
                        <div className="profile__text ">
                            <p className="profile__subTit whiteSpaceNo split4-14">
                                What do you think makes front-end development
                                attractive?
                            </p>
                            <p className="profile__subDe split4-15">
                                프론트엔드의 영역은 코드와 디자인이 만나는
                                독특한 공간이기에, 웹 개발에 있어 프론트엔드가
                                할 수 있는 일이 정말 많다고 생각합니다. 그만큼
                                부딪혀야 할 일이 많아 험난할 것이라 예상되지만
                    ...
                    <div className="right__wrap r6">
                        ...
                        <div className="profile__text ">
                            <p className="profile__subTit whiteSpaceNo split4-17">
                                What do you think makes front-end development
                                attractive?
                            </p>
                            <p className="profile__subDe split4-18">
                                프론트엔드의 영역은 코드와 디자인이 만나는
                                독특한 공간이기에, 웹 개발에 있어 프론트엔드가
                                할 수 있는 일이 정말 많다고 생각합니다. 그만큼
                                부딪혀야 할 일이 많아 험난할 것이라 예상되지만
